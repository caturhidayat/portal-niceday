    ...
    <header className="sticky top-0 h-16 gap-4 border-b bg-background w-full flex px-4 z-10">
      <NavigationMenu>
        ...
        <NavigationMenuList className="pl-4">
            ...
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                {employees.map((employee) => (
                  <Link key={employee.title} href={employee.href}>
                    <ListItem title={employee.title}></ListItem>
                  </Link>
                ))}
              </ul>
            </NavigationMenuContent>
          ...
          <NavigationMenuItem>
            <NavigationMenuTrigger>Time & Attendance</NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                {timeManagements.map((timeManage) => (
                  <Link key={timeManage.title} href={timeManage.href}>
                    <ListItem title={timeManage.title}></ListItem>
                  </Link>
                ))}
              </ul>
            </NavigationMenuContent>
